...
const Loading_Planeswalker_symbol: React.FC = () => {
  return (
...
<svg
  ...
  viewBox="0 0 457.94 823.53998"  // Updated viewBox width to match the symbol's width
  preserveAspectRatio="xMidYMid meet"  // Changed from "slice" to "meet"
>
      <path
...
export default Loading_Planeswalker_symbol;